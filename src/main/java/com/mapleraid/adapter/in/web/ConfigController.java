...
import com.mapleraid.adapter.in.web.dto.BossConfigDto;
import com.mapleraid.adapter.in.web.dto.WorldGroupConfigDto;
...
public class ConfigController {
    ...
    public ResponseEntity<ApiResponse<List<WorldGroupConfigDto>>> getWorldGroups() throws IOException {
    ...
    @GetMapping("/bosses")
    public ResponseEntity<ApiResponse<List<BossConfigDto>>> getBosses() throws IOException {
    ...
    public ResponseEntity<ApiResponse<JsonNode>> getBossBundles() throws IOException {
