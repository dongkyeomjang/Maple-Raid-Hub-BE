...
@Getter
public class CompleteOauthSignupResult extends SelfValidating<CompleteOauthSignupResult> {
    ...
    public CompleteOauthSignupResult(
            String userId,
            String username,
            String nickname,
            boolean nicknameSet,
    ...
    public static CompleteOauthSignupResult from(User user) {
        return new CompleteOauthSignupResult(
