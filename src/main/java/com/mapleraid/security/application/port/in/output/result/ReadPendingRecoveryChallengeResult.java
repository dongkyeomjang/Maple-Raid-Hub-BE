...
@Getter
public class ReadPendingRecoveryChallengeResult extends SelfValidating<ReadPendingRecoveryChallengeResult> {
    ...
    private ReadPendingRecoveryChallengeResult(
            boolean exists, String id, String characterId,
            String requiredSymbol1, String requiredSymbol2,
            EChallengeStatus status,
            LocalDateTime createdAt, LocalDateTime expiresAt,
            int checkCount, int maxChecks,
            Integer remainingChecks, Long remainingTimeSeconds,
            boolean canCheck, Long secondsUntilNextCheck
    ) {
        this.exists = exists;
        this.id = id;
    ...
    public static ReadPendingRecoveryChallengeResult from(VerificationChallenge challenge) {
        return new ReadPendingRecoveryChallengeResult(
                true,
    ...
    public static ReadPendingRecoveryChallengeResult empty() {
        return new ReadPendingRecoveryChallengeResult(
