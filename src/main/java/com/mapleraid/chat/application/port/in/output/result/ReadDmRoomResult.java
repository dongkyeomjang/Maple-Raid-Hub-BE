...
@Getter
public class ReadDmRoomResult extends SelfValidating<ReadDmRoomResult> {
    ...
    public ReadDmRoomResult(String id, String postId, String user1Id, String user2Id,
    ...
    public static ReadDmRoomResult from(DirectMessageRoom room) {
        return new ReadDmRoomResult(
