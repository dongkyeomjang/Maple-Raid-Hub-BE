...
@Getter
public class SyncCharacterResult extends SelfValidating<SyncCharacterResult> {
    ...
    public static SyncCharacterResult of(
            String id,
            String characterName,
            String worldName,
            EWorldGroup worldGroup,
        ...
        return new SyncCharacterResult(
                id,
                characterName,
                worldName,
                worldGroup,
