...
public enum ErrorCode {
    ...
    MANNER_SELF_EVALUATION(40018, HttpStatus.BAD_REQUEST, "본인에게는 매너 평가를 할 수 없습니다."),
    MANNER_NO_TAGS(40019, HttpStatus.BAD_REQUEST, "최소 1개의 태그를 선택해야 합니다."),
    MANNER_TOO_MANY_TAGS(40020, HttpStatus.BAD_REQUEST, "최대 3개의 태그만 선택할 수 있습니다."),
    MANNER_MONTHLY_LIMIT(40021, HttpStatus.BAD_REQUEST, "같은 사용자에게 30일에 1회만 평가할 수 있습니다."),
    MANNER_MIXED_TAGS(40045, HttpStatus.BAD_REQUEST, "긍정 태그와 부정 태그를 함께 선택할 수 없습니다."),
